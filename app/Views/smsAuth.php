                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    <form action="<?= base_url('/smsAuth') ?>" method="post">
                                        <input type="hidden" name="action" value="select_mobile">
                                        <div class="mb-3">
                                            <label class="form-label" for="code">List Mobile number</label>



                                            <select class="form-control" id="select_mobile" name="select_mobile">

                                                <option value="default"><?php 
                                                
                                              echo  $maskedPhonedef = substr( $default, 0, 3) . "****" . substr( $default, 7, 4);
                                                ...
                                                if (!empty($list_mobile)) {
                                                    foreach ($list_mobile as $row) { ?>
                                                        ...
                                                        <option name="select_mobile" value="<?= $row['id']; ?>"> <?= 
                                            ...
                                            <div class="mt-3 text-end">
                                                <button class="btn btn-primary w-sm waves-effect waves-light" type="submit">select</button>
                                            </div>
                                    ...
                                    <div class="alert alert-success text-center mb-4" role="alert">
                                        Enter your 6 number code ! (<?php echo $sms_code ?>)
                                    </div>
                                    <form action="<?= base_url('/smsAuth') ?>" method="post">
