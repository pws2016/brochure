                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="true">
                                    <li><a href="<?php echo base_url($prefix_route.'requests?plan_type=simple')?>">BasicPlan</a></li>
									<li><a href="<?php echo base_url($prefix_route.'requests?plan_type=full')?>">Certificazioni</a></li>
									<hr>
									<li><a href="<?php echo base_url($prefix_route.'requests?plan_type=business')?>">BMPlan</a></li>
                                </ul>
                            </li>
							<li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    <i class="uil-flask"></i>
                                    <span>Generazione di proposte</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="auth-login.html">Chiamate</a></li>
                                    <li><a href="auth-register.html">Offerte</a></li>
									<hr>
                                    <li><a href="auth-recoverpw.html">Lista servizi</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="ecommerce-products.html">Pacchetti</a></li>
                                    <li><a href="ecommerce-product-detail.html">Coupon</a></li>
                                </ul>
                            </li>
