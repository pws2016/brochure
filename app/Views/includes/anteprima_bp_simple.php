...
<head>
	...
	<style>
		...
		h3.h3, h4.h4{border-bottom: 3px solid <?php echo $request_data_inf['logo_color']?>;color: <?php echo $request_data_inf['logo_color']?>;}
		h5.h5{color:<?php echo $request_data_inf['logo_color']?>;}
            ...
            <div class="row">
                ...
                <div class="col-lg-12 mb-5">
                    <div>
						...
						<div id="social_pie_chart" style="width: 960px; height: 500px;" ></div>
                ...
                <div class="col-lg-12 mb-5">
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-4">
							...
							<p class="<?php if($is_crypted==true) echo 'text_flou'?>"><?php $str= $request_data_inf['description_activity']; if($is_crypted==true) echo str_shuffle(strip_tags($str)) ;
						else echo $str;?></p>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-4">
							...
							<p class="<?php if($is_crypted==true) echo 'text_flou'?>"><?php  $str= $request_data_inf['realized_activity']; if($is_crypted==true) echo str_shuffle(strip_tags($str)) ;
						else echo $str;?>
							</p>
                        </div>
                    </div>
                ...
                <div class="col-lg-12 mb-5">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
							...
							<p class="<?php if($is_crypted==true) echo 'text_flou'?>"><?php $str= $request_data_inf['problem_solution']; if($is_crypted==true) echo str_shuffle(strip_tags($str)) ;
						else echo $str;?></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12 mb-5">
                    <div>
					  ...
					  <div class="row">
                        <div class="col-lg-12 mb-4">
							...
							<p class="<?php if($is_crypted==true) echo 'text_flou'?>"><?php $str= $request_data_inf['mercato_description'];if($is_crypted==true) echo str_shuffle(strip_tags($str)) ;
						else echo $str;?></p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-4">
							...
							<p class="<?php if($is_crypted==true) echo 'text_flou'?>"><?php $str= $request_data_inf['mercato_potenziale'];if($is_crypted==true) echo str_shuffle(strip_tags($str)) ;
						else echo $str;?></p>
                        </div>
                    </div>
					<?php } 
                ...
                <div class="col-lg-12 mb-5">
					...
					?>
					<P class="<?php if($is_crypted==true) echo 'text_flou'?>"><?php if(in_array('1',$checks)) echo '&#9745;'; else echo '&#9744;'?> Previsione opzioni put e call con diritto di vendita e riacquisto a prezzo stabilito della partecipazione</P>

<P class="<?php if($is_crypted==true) echo 'text_flou'?>"><?php if(in_array('2',$checks)) echo '&#9745;'; else echo '&#9744;'?> <?php $str="Previsione di cessione della maggioranza con clausole di trascinamento";if($is_crypted==true) echo str_shuffle(strip_tags($str)) ; else echo $str;?></P>

<P class="<?php if($is_crypted==true) echo 'text_flou'?>"><?php if(in_array('3',$checks)) echo '&#9745;'; else echo '&#9744;'?> <?php $str="Restituzione dell’investimento a data e rendimenti definiti";if($is_crypted==true) echo str_shuffle(strip_tags($str)) ;else echo $str;?></P>

<P class="<?php if($is_crypted==true) echo 'text_flou'?>"><?php if(in_array('4',$checks)) echo '&#9745;'; else echo '&#9744;'?> <?php $str="Exit totale e quasi exit con cessione delle partecipazioni a gruppo industriale o big company";if($is_crypted==true) echo str_shuffle(strip_tags($str)) ;else echo $str;?></P>

<P class="<?php if($is_crypted==true) echo 'text_flou'?>"><?php if(in_array('5',$checks)) echo '&#9745;'; else echo '&#9744;'?><?php $str="Cessione totale o in licenza dei diritti di sfruttamento e relativo pagamento di royalties";if($is_crypted==true) echo str_shuffle(strip_tags($str)) ;else echo $str;?></P>

<P class="<?php if($is_crypted==true) echo 'text_flou'?>"><?php if(in_array('6',$checks)) echo '&#9745;'; else echo '&#9744;'?> Altro (descrivere) <br/><?php $str= $request_data_inf['strategy_other'];if($is_crypted==true) echo str_shuffle(strip_tags($str)) ; else echo $str;
						?></P>
						<?php if(trim(strip_tags($request_data_inf['scalabilita']))!=""){?>	
                    <div class="row">
                        <div class="col-lg-12 mb-2">
                            <h5 class="mb-2 h5">Scalabilità</h5>
							<p class="<?php if($is_crypted==true) echo 'text_flou'?>"><?php  $str=  $request_data_inf['scalabilita'];if($is_crypted==true) echo str_shuffle(strip_tags($str)) ;
						else echo $str;?></p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-2">
							...
							<p class="<?php if($is_crypted==true) echo 'text_flou'?>"><?php  $str=  $request_data_inf['riproducibilita'];if($is_crypted==true) echo str_shuffle(strip_tags($str)) ;
						else echo $str;?></p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-2">
							...
							<p class="<?php if($is_crypted==true) echo 'text_flou'?>"><?php  $str=  $request_data_inf['competitivo_monetizzabile'];if($is_crypted==true) echo str_shuffle(strip_tags($str)) ;
						else echo $str;?></p>
                        </div>
                    </div>
						<?php } ?>
                ...
                <div class="col-lg-12 mb-5">
					...
					<div class="row">
						<table class="table table-step-shipping table-sm <?php if($is_crypted==true) echo 'text_flou'?>">
							<thead class="table-light">
								<tr>
									<th>&nbsp;</th>
