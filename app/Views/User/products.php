            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
						...
						<div class="col-12">
							<p>Clicca su <b>+ Agg. Nuovo</b> per creare un nuovo prodotto.</p>
						</div>
                    </div>
                    <!-- end page title -->
                                ...
                                <div class="card-body">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <form action="<?= base_url('user/products/insert') ?>" method="post" id="form" enctype="multipart/form-data">
                                    ...
                                    <form action="<?= base_url('user/products/update') ?>" method="post" id="form" enctype="multipart/form-data">
