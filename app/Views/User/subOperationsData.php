                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">Sub Operations Data</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"></li>
                                        <li class="breadcrumb-item active">Sub Operations Data</li>
                                    </ol>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-md-6">
                                            ...
                                            <form action="<?= base_url('user/subOperationsData/insert') ?>" method="post" id="form" enctype="multiope/form-data">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                ...
                                                                <h5 class="modal-title" id="exampleModalLabel"> Add Sub_Operations data</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div class="input-group" id="datepicker1">
                                                                            <input type="text" class="form-control" name="date" placeholder="dd/mm/yyyy" data-date-format="dd/mm/yyyy" data-date-container='#datepicker1' data-provide="datepicker">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="description">Sede</label><span class="text-primary">*</span>
                                                                    <textarea id="sede" name="sede" class="md-textarea form-control" rows="3 "></textarea>
                                                                </div>
                                    ...
                                    <form action="<?= base_url('user/subOperationsData/update') ?>" method="post" id="form" enctype="multipart/form-data">
                                        <input type="hidden" name="id_parent" value="<?php echo $id_parent ?>">
			...
			tinymce.init({
				...
				content_style: 'body { font-family:Helvetica,Arial,sans-serif; font-size:14px }'
                            ...
                            function get_data(id) {
                                $.ajax({
                                    url: "<?php echo base_url("user/subOperationsData/get_data"); ?>",
                                    type: "POST",
                                    cache: false,
                                    data: {
				...
				content_style: 'body { font-family:Helvetica,Arial,sans-serif; font-size:14px }'
                            ...
                            function del_pack(id) {
                                if (confirm("are you sure !")) {
                                    $.ajax({
                                        url: "<?php echo base_url("user/subOperationsData/delete"); ?>",
                                        type: "GET",
                                        cache: false,
                                        data: {
