...
<body data-sidebar="dark">
    <div id="layout-wrapper">
        ...
        <div class="main-content">
         ...
         <a class="pull-right btn btn-warning btn-large" style="margin-right:40px" href="<?php echo base_url('user/operations/createExcel'); ?>"><i class="fa fa-file-excel-o">
                                        ...
                                        <form action="<?= base_url('user/operations/update') ?>" method="post" id="form" enctype="multipart/form-data">
                                        ...
                                        echo form_open(base_url('user/operations'), $attributes); ?>
                            ...
                            <script>
                                ...
                                function get_data(id) {
                                    $.ajax({
                                        url: "<?php echo base_url("user/operations/get_data"); ?>",
                                        type: "POST",
                                        cache: false,
                                        data: {
                                ...
                                function del_pack(id) {
                                    if (confirm("are you sure !")) {
                                        $.ajax({
                                            url: "<?php echo base_url("user/operations/delete"); ?>",
                                            type: "GET",
                                            cache: false,
                                            data: {
                                ...
                                function block_item(id, enable) {
                                    ...
                                    $.ajax({
                                        url: "<?php echo base_url("user/operations/get_block_data"); ?>",
                                        type: "POST",
                                        cache: false,
                                        data: {
